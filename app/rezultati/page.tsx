        ...
        <Container className="relative z-10 pt-10 pb-12 sm:pt-12 sm:pb-14 lg:pt-14 lg:pb-16">
          <div className="header-stack max-w-2xl">
            ...
            <p className="text-body-inverse-sm max-w-[52ch]">
              ...
              ne kot enotno obljubo za vsak primer.
            </p>
          ...
          <div className="section-gap">
            <div className="header-stack max-w-3xl">
              ...
              <p className="text-body-lg max-w-[56ch]">
                ...
                in kako se rezultat razvija skozi čas.
              </p>
          ...
          <div className="section-gap">
            <div className="header-stack max-w-3xl">
              ...
              <h2 className="heading-section text-white">
                Potek odstranjevanja v praksi
              </h2>

              <p className="text-body-inverse-lg max-w-[56ch]">
                Prikaz dejanskega postopka odstranjevanja tattooja s Pico laserjem.
              </p>
            </div>
            ...
            <p className="text-body-inverse max-w-[52ch] text-white/65">
              Video je informativne narave. Potek in rezultat sta vedno odvisna od
              posameznega tattooja in odziva kože.
            </p>
          </div>
        </Container>
          ...
          <div className="mx-auto flex max-w-3xl flex-col items-center text-center">
            <div className="flex flex-col items-center gap-4 sm:gap-5">
              ...
              <p className="text-body-inverse max-w-[52ch]">
                Najboljši način ocene je posvet, kjer pregledamo tattoo in
            ...
            <div className="cta-spacing flex flex-col items-center">
              <div className="flex flex-wrap justify-center gap-4">
                ...
                <Button href="/odstranjevanje-tattoojev" variant="secondary-dark">
                  Poglej postopek odstranjevanja
                </Button>
              </div>
              ...
              <div className="flex flex-col gap-2 pt-3">
                ...
                <p className="mt-4 text-sm text-white/50">
                  Posvet je namenjen realni oceni vašega primera.
                </p>
              </div>
            </div>
          </div>
