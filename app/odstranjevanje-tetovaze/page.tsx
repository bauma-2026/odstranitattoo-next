...
export default function OdstranjevanjeTetovazePage() {
  return (
    <main className="bg-white text-neutral-900">
      ...
      <section className="section-sm">
        <Container>
          <div className="grid gap-12 lg:grid-cols-[1fr_0.95fr] lg:items-start lg:gap-14">
  ...
  <div className="flex flex-col gap-3">
    <p className="text-sm font-medium uppercase tracking-[0.14em] text-skin-500/90">
      Realna pričakovanja
    </p>
        ...
        <Container>
          ...
          <div className="mt-14 grid gap-6 sm:grid-cols-2">
            {factors.map((item) => (
              <div
                key={item.title}
                className="image-block border border-neutral-200 bg-white p-6"
              >
                <div className="flex flex-col gap-3">
