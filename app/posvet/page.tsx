    ...
    <Container className="relative z-10 pt-10 pb-12 sm:pt-12 sm:pb-14 lg:pt-14 lg:pb-16">
      <div className="header-stack max-w-2xl">
        ...
        <p className="text-body-inverse-lg max-w-[52ch] sm:hidden">
          Na posvetu pregledamo tattoo in vam jasno povemo, kaj je pri vašem
          primeru smiselno pričakovati.
        </p>

        {/* DESKTOP */}
        <p className="hidden max-w-[52ch] text-body-inverse-lg sm:block">
        ...
        {/* MOBILE */}
        <p className="max-w-[52ch] text-body-inverse-sm sm:hidden">
          Cilj je jasna ocena in miren naslednji korak.
        </p>

        {/* DESKTOP */}
        <p className="hidden max-w-[52ch] text-body-inverse-sm sm:block">
          Cilj posveta je jasna ocena, realna pričakovanja in miren naslednji
          korak.
        </p>
  ...
  <section className="section-tight bg-white">
    <Container>
      <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-start lg:gap-10">
        {/* WHITE SIDE */}
        <div className="rounded-[28px] bg-white pt-4 pb-6 px-5 sm:pt-6 sm:pb-8 sm:px-8">
            ...
            <div className="flex flex-col divide-y divide-neutral-200/70">
              <div className="py-5 first:pt-0">
                ...
                <p className="mt-2 max-w-[46ch] text-body">
                  Ocenimo velikost, pigment, starost tattooja in stanje kože,
                  ker vse to vpliva na potek odstranjevanja.
                </p>
              </div>
          ...
          <div className="flex flex-col gap-7">
            <div className="flex flex-col gap-3">
              ...
              <p className="max-w-[34ch] text-body-inverse">
                ...
                pošti. Posvet je namenjen jasni oceni tattooja in realni razlagi
