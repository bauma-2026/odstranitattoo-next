  ...
  <Container className="relative z-10 pt-10 pb-12 sm:pt-12 sm:pb-14 lg:pt-14 lg:pb-16">
    <div className="header-stack max-w-2xl">
      ...
      <p className="text-body-inverse-lg max-w-[54ch]">
        Za posvet, vprašanja ali termin nas lahko kontaktirate po telefonu ali e-pošti.
      </p>
  ...
  <div className="flex flex-col gap-6">
    <div className="flex flex-col gap-3">
      ...
      <p className="text-body-inverse">
        Pred začetkom odstranjevanja najprej ocenimo tattoo in določimo realna pričakovanja.
      </p>
    </div>
    ...
    <p className="text-sm text-white/50">
      Posvet je namenjen jasni oceni vašega primera.
    </p>
  </div>
</div>      </div>
