...
const faqs = [
  ...
  },
  {
    ...
    a: "Število tretmajev je odvisno od pigmenta, globine nanosa in odziva kože. Nekateri tattooji bledijo hitreje, drugi potrebujejo več časa. Na posvetu dobite realno oceno glede na vaš primer.",
  },
  {
    q: "Ali odstranjevanje tattooja boli?",
    a: "Občutek je odvisen od mesta tattooja in vaše občutljivosti. Večina ga opisuje kot hitro pikanje ali občutek podobno rahlemu \"šviku\" po koži. Tretma je kratek, po potrebi pa poskrbimo za večje udobje.",
  },
  {
  ...
  },
  {
    ...
    a: "Med tretmaji je potreben čas, da se koža obnovi in telo odstrani razbite delce pigmenta. Razmiki so običajno več tednov, natančen potek pa prilagodimo glede na kožo in tattoo.",
  },
  {
  ...
  },
  {
    ...
    a: "Tveganje za brazgotine je pri sodobni Pico laser tehnologiji majhno. Pomembna sta pravilno izveden tretma in ustrezna nega po postopku, ki jo natančno razložimo na posvetu.",
  },
  {
    q: "Ali lahko odstranim samo del tattooja ali ga posvetlim za cover-up?",
    a: "Da. Tattoo lahko odstranjujemo postopoma ali ga svetlimo do točke, primerne za prekrivanje. Postopek vedno prilagodimo vašemu cilju.",
  },
  {
    q: "Koliko stane odstranjevanje tattooja?",
    a: "Cena je odvisna od velikosti, zahtevnosti in cilja odstranjevanja. Na posvetu dobite jasno oceno stroška ter predlog smiselnega poteka odstranjevanja.",
  },
];
        ...
        <Container className="max-w-3xl">
          <div className="section-gap">
            ...
            <div className="header-stack max-w-2xl">
              ...
              <p className="text-body-lg max-w-[44ch] text-neutral-700">
            ...
            <div className="border-t border-neutral-200/60 pt-6 sm:pt-8">
              <p className="text-body-sm max-w-[56ch] text-neutral-500">
                Če vašega primera ne najdete tukaj, ga skupaj pogledamo na
                posvetu in vam jasno povemo, kaj je smiselno pričakovati.
              </p>
            </div>
        ...
        <Container>
          <div className="section-gap">
            <div className="mx-auto flex max-w-2xl flex-col items-center gap-5 text-center">
              <p className="text-sm text-neutral-500">Še vedno imate vprašanje?</p>
              ...
              <p className="text-body-lg max-w-[42ch] text-neutral-700">
                 Na posvetu odgovorimo na vaša vprašanja in vam jasno povemo,
